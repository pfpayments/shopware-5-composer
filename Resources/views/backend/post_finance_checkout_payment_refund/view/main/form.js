...
//{block name="backend/postfinancecheckout_payment_refund/view/main/form"}
//{namespace name=backend/postfinancecheckout_payment/main}
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentRefund.view.main.Form', {
    
    extend: 'Ext.grid.Panel',
    
    alias: 'widget.postfinancecheckout-payment-refund-main-form',
            ...
            },
            {
                ...
                renderer: function(value, meta, record){
                    ...
                    return {
                        ...
                        items: [{
                            xtype: 'displayfield',
                            cls: 'postfinancecheckout-payment-refund-reduction-value',
                            initComponent: function(){
                                var me = this;
                                me.callParent(arguments);
