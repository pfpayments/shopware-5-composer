...
//{block name="backend/postfinancecheckout_payment_refund/view/main/window"}
//{namespace name=backend/postfinancecheckout_payment/main}
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentRefund.view.main.Window', {
    
    extend: 'Enlight.app.Window',
    
    title: '{s name=refund/window/title}Create Refund{/s}',
    
    alias: 'widget.postfinancecheckout-payment-refund-main-window',
    ...
    createForm: function() {
        ...
        var form = Ext.create('Shopware.apps.PostFinanceCheckoutPaymentRefund.view.main.Form', {
            region: 'center',
            record: me.record,
    ...
    createActionButtons: function() {
        ...
        return [{
            ...
            cls: 'secondary',
            action: 'postfinancecheckout-payment-refund-main-window-cancel'
        }, {
            text: me.snippets.button.create,
            cls: 'primary',
            action: 'postfinancecheckout-payment-refund-main-window-create'
        }];
    }
