...
//{block name="backend/postfinancecheckout_payment_transaction/controller/transaction"}
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentTransaction.controller.Transaction', {
    ...
    init:function () {
        ...
        me.control({
            'postfinancecheckout-payment-transaction-details': {
            ...
            'postfinancecheckout-payment-transaction-line-items': {
    ...
    onUpdateLineItems: function(record, grid) {
        ...
        Ext.Ajax.request({
            url: '{url controller="PostFinanceCheckoutPaymentTransaction" action="saveLineItem"}',
            params: params,
    ...
    onDownloadInvoice: function(record, view) {
        window.open('{url controller="PostFinanceCheckoutPaymentTransaction" action=downloadInvoice}?id=' + record.get('id'), 'download');
    },
    
    onDownloadPackingSlip: function(record, view) {
        window.open('{url controller="PostFinanceCheckoutPaymentTransaction" action=downloadPackingSlip}?id=' + record.get('id'), 'download');
    },
    ...
    onVoidTransaction: function(record, view) {
        ...
        if (record.get('canVoid')) {
            me.process(record, view, '{url controller="PostFinanceCheckoutPaymentTransaction" action="void"}',
    ...
    onCompleteTransaction: function(record, view) {
        ...
        if (record.get('canComplete')) {
            me.process(record, view, '{url controller="PostFinanceCheckoutPaymentTransaction" action="complete"}',
    ...
    onDenyDeliveryIndication: function(record, view) {
        ...
        if (record.get('canReview')) {
            me.process(record, view, '{url controller="PostFinanceCheckoutPaymentTransaction" action="deny"}',
    ...
    onAcceptDeliveryIndication: function(record, view) {
        ...
        if (record.get('canReview')) {
            me.process(record, view, '{url controller="PostFinanceCheckoutPaymentTransaction" action="accept"}',
    ...
    onUpdateTransaction: function(record, view) {
    		...
    		me.process(record, view, '{url controller="PostFinanceCheckoutPaymentTransaction" action="update"}',
