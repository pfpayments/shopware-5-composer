...
//{block name="backend/postfinancecheckout_payment_transaction/view/transaction/refunds/details"}
//{namespace name=backend/postfinancecheckout_payment/main}
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentTransaction.view.transaction.Refunds.Details', {
    
    extend: 'Ext.panel.Panel',
    
    alias: 'widget.postfinancecheckout-payment-transaction-refunds-details',
    ...
    createLineItemPanel: function(){
        ...
        var panel = Ext.create('Shopware.apps.PostFinanceCheckoutPaymentTransaction.view.transaction.LineItems.Grid', {
            name: 'postfinancecheckout-payment-transaction-line-item-grid',
            record: me.record,
