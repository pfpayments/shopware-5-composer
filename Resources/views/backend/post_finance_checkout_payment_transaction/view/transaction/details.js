...
//{block name="backend/postfinancecheckout_payment_transaction/view/transaction/details"}
//{namespace name=backend/postfinancecheckout_payment/main}
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentTransaction.view.transaction.Details', {
    
    extend: 'Ext.panel.Panel',
    
    alias: 'widget.postfinancecheckout-payment-transaction-details',
