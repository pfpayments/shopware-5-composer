...
//{block name="backend/postfinancecheckout_payment_transaction/view/transaction/line_items/grid"}
//{namespace name=backend/postfinancecheckout_payment/main}
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentTransaction.view.transaction.LineItems.Grid', {

    extend: 'Ext.grid.Panel',

    alias: 'widget.postfinancecheckout-payment-transaction-line-items-grid',
