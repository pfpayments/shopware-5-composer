...
Ext.define('Shopware.apps.PostFinanceCheckoutPaymentManualTasksWidget.view.Main', {
    ...
    load: function(callback){
        ...
        Ext.Ajax.request({
            url: '{url controller=PostFinanceCheckoutPaymentManualTasksWidget action=info}',
            async: true,
