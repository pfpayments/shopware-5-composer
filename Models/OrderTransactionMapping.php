...
namespace PostFinanceCheckoutPayment\Models;
...
/**
 * @ORM\Table(name="postfinancecheckout_payment_order_transaction_mapping",
 *      uniqueConstraints={
 ...
 *          query="SELECT m.orderEmailSent FROM PostFinanceCheckoutPayment\Models\OrderTransactionMapping m WHERE m.orderId = :orderId"
 *      ),
 *      @ORM\NamedQuery(
 *          name="getOrderEmailData",
 *          query="SELECT m.orderEmailSent, m.orderEmailVariables FROM PostFinanceCheckoutPayment\Models\OrderTransactionMapping m WHERE m.orderId = :orderId"
 *      ),
 *      @ORM\NamedQuery(
 *          name="updateOrderEmailSent",
 *          query="UPDATE PostFinanceCheckoutPayment\Models\OrderTransactionMapping m SET m.orderEmailSent = true, m.orderEmailVariables = null WHERE m.orderId = :orderId"
 *      ),
 *      @ORM\NamedQuery(
 *          name="lock",
 *          query="UPDATE PostFinanceCheckoutPayment\Models\OrderTransactionMapping m SET m.lockedAt = CURRENT_TIMESTAMP() WHERE m.orderId = :orderId"
 *      )
 * })
 */
