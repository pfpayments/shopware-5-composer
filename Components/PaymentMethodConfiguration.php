...
use PostFinanceCheckoutPayment\Components\Provider\PaymentMethod as PaymentMethodProvider;
...
class PaymentMethodConfiguration
{
    ...
    public function synchronize()
    {
        ...
        foreach ($this->modelManager->getRepository(Shop::class)->findAll() as $shop) {
            ...
            if ($spaceId && ! in_array($spaceId, $spaceIds)) {
                $paymentMethodConfigurationService = new \PostFinanceCheckout\Sdk\Service\PaymentMethodConfigurationService($this->apiClient);
    ...
    private function updatePaymentMethods()
    {
        ...
        foreach ($configurations as $configuration) {
            ...
            $payment = $this->paymentInstaller->createOrUpdate($pluginName, [
                'name' => 'postfinancecheckout_' . $configuration->getId(),
                ...
                'action' => 'PostFinanceCheckoutPaymentPay'
            ]);
     ...
     * @return string
     */
    private function getConfigurationState(\PostFinanceCheckout\Sdk\Model\PaymentMethodConfiguration $configuration)
    {
