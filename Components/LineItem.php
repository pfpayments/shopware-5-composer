...
class LineItem extends AbstractService
{
    ...
    public function collectBasketLineItems()
    {
        ...
        $pluginConfig = $this->configReader->getByPluginName('PostFinanceCheckoutPayment', Shopware()->Shop());
    ...
    private function adjustLineItems(array &$lineItems, $expectedSum, $currency)
    {
        ...
        $adjustmentLineItem->setType(
            $difference > 0 ? \PostFinanceCheckout\Sdk\Model\LineItemType::FEE : \PostFinanceCheckout\Sdk\Model\LineItemType::DISCOUNT);
